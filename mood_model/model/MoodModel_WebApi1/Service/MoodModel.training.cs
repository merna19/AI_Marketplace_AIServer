...
namespace MoodModel_WebApi1
{
    public partial class MoodModel
    {
        public const string RetrainFilePath =  @"F:\iti\.net full stack\final project\AI GitHub Repo\mood_model\training data\mood_dataset7.csv";
